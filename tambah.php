				...
				<center>
					<table style='color:black;'>
						<tr>
							<td>foto</td>
							<td>:</td>
							<td><input type='file' name='foto' size='100' /></td>
						</tr>
						<tr>
							<td>Type</td>
							<td>:</td>
							<td><input type='text' name='nmtype' placeholder='Daihatsu/Honda/Toyota' size='10'/></td>
						</tr>
						<tr>
							<td>ID type</td>
							<td>:</td>
							<td><input type='text' name='idtype' placeholder='ID type' size='10'/></td>
						</tr>
						<tr>
							<td>Merk</td>
							<td>:</td>
							<td><input type='text' name='nmmerk' placeholder='Avanza/Jazz/Xenia' size='10'/></td>
						</tr>
						<tr>
							<td>kodemerk</td>
							<td>:</td>
							<td><input type='text' name='kodemerk' placeholder='harus sama dgn ID type' size='10'/></td>
						</tr>
						<tr>
							<td>tarifperjam</td>
							<td>:</td>
							<td><input type='text' name='tarifperjam' size='30' placeholder='tarifperjam mobil'></td>
						</tr>
						<tr>
							<td>noplat</td>
							<td>:</td>
							<td><input type='text' name='noplat' size='20' placeholder='noplat'></td>
						</tr>
						<tr>
							<td>tahun</td>
							<td>:</td>
							<td><input type='text' name='tahun' size='20' placeholder='tahun'></td>
						</tr>
						<tr>
							<td>StatusRental</td>
							<td>:</td>
							<td><input type='text' name='statusrental' size='20' placeholder='status rental'></td>
						</tr>
						<tr>
							<td>KodePemilik</td>
							<td>:</td>
							<td><input type='text' name='kodepemilik' size='20' placeholder='kode pemilik'></td>
						</tr>
						<tr>
