	...
	<body>
		<div id='container'>
			...
			<div id='content'>
				...
				<form action='perubahan.php?idtype=$idtype' method='POST'>
				<center>
				<h2><b style='color:white; font-weight:bold;'>Ubah Mobil</b></h2>
					<table style='color:black;'>
						...
						<tr>
							<td>tarifperjam</td>
							<td>:</td>
							<td><input type='text' name='tarifperjam' size='30' placeholder='tarifperjam mobil' value='$tarifperjam' /></td>
						</tr>
						<tr>
							<td>noplat</td>
							<td>:</td>
							<td><input type='text' name='noplat' size='20' placeholder='noplat' value='$noplat'/></td>
						</tr>
						<tr>
							<td>tahun</td>
							<td>:</td>
							<td><input type='text' name='tahun' size='20' placeholder='tahun' value='$tahun'/></td>
						</tr>
						<tr>
							<td>StatusRental</td>
							<td>:</td>
							<td><input type='text' name='statusrental' size='20' placeholder='status rental' value='$statusrental'/></td>
						</tr>
						<tr>
							<td>KodePemilik</td>
							<td>:</td>
							<td><input type='text' name='kodepemilik' size='20' placeholder='kode pemilik' value='$kodepemilik'/></td>
						</tr>
						<tr>
							<td align='center'></td>
							<td></td>
